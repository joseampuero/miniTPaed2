...
public:
    ...
    void comprar(Parte p, _ID parte);
     ...
     * retornaremos true y la linea(en particular el ID) con la que esta trabajando,
     * si no, <false, null> el empleado no esta realizando ninguna transaccion*/
    tuple<bool, itCatalogo._ID> estaOcupado(empleado e)const;
